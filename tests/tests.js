    ...
    var createTests = function (platformOpts) {
        ...
        describe('cordova.InAppBrowser', function () {
            ...
            it('inappbrowser.spec.2 should contain open function', function () {
                expect(cordova.InAppBrowserPopUp.open).toBeDefined();
                expect(cordova.InAppBrowserPopUp.open).toEqual(jasmine.any(Function));
            });
        });
        ...
        describe('open method', function () {
            ...
            it('inappbrowser.spec.3 should return InAppBrowser instance with required methods', function () {
                iabInstance = cordova.InAppBrowserPopUp.open(url, '_blank', platformOpts);
            ...
            it('inappbrowser.spec.6 should support loaderror event', function (done) {
                ...
                iabInstance = cordova.InAppBrowserPopUp.open(badUrl, '_blank', platformOpts);
...
exports.defineManualTests = function (contentEl, createActionButton) {
    ...
    function doOpen (url, target, params, numExpectedRedirects, useWindowOpen) {
        ...
        if (useWindowOpen) {
            ...
            iab = cordova.InAppBrowserPopUp.open(url, target, params, callbacks);
        }
        if (!iab) {
    ...
    function doHookOpen (url, target, params, numExpectedRedirects) {
        ...
        window.open = cordova.InAppBrowserPopUp.open;
    ...
    function openHidden (url, startHidden) {
        ...
        hiddenwnd = cordova.InAppBrowserPopUp.open(url, 'random_string', shopt);
        if (!hiddenwnd) {
            alert('cordova.InAppBrowserPopUp.open returned ' + hiddenwnd); // eslint-disable-line no-undef
            return;
        }
    ...
    createActionButton(
        ...
        function () {
            var ref = cordova.InAppBrowserPopUp.open('https://google.com', '_blank', 'location=yes' + (platformOpts ? ',' + platformOpts : ''));
            ref.addEventListener('loadstop', function () {
                ref.close();
            });
            ref.addEventListener('exit', function () {
                var ref2 = cordova.InAppBrowserPopUp.open(
                    'https://google.com',
                    '_blank',
                ...
                ref2.addEventListener('exit', function () {
                    cordova.InAppBrowserPopUp.open('https://google.com', '_blank', 'location=yes' + (platformOpts ? ',' + platformOpts : ''));
                });
            });
        },
